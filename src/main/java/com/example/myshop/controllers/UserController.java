...
import com.example.myshop.enumm.Status;
...
//        System.out.println("Пароль пользователя: " + personDetails.getPerson().getPassword());
    ...
    public String cart(Model model) {
        ...
        model.addAttribute("cartProduct", productList);
        return "user/cart";
    }
    ...
    public String deleteProductFromCart(Model model, @PathVariable("id") int id) {
        ...
        PersonDetails personDetails = (PersonDetails) authentication.getPrincipal();
        int idPerson = personDetails.getPerson().getId();
        cartRepository.deleteCartById(id, idPerson);
        return "redirect:/cart";
    }
...
//    }
    ...
    public String createOrder() {
        ...
        for (Product product : productList) {
            ...
            cartRepository.deleteCartById(product.getId(), idPerson);
        }
