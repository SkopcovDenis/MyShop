...
//import com.example.myshop.security.AuthenticationProvider;
...
//                .antMatchers("/user").hasAnyRole("USER")
                ...
                .antMatchers("/auth/login", "/error", "/auth/registration", "/product", "/user/search", "/product/info/{id}", "/img/**", "/product/search").permitAll()
